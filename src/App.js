...
import Boss from './features/bosses/Boss';
    ...
    <div className="container-fluid mt-3 app-main-background d-flex flex-column min-vh-100">
      ...
      <div className="row mb-3">
        <div className="col-md-12 p-3 d-flex justify-content-between align-items-center">
          <h1 className="h3 mb-0 app-header-container">Goal Raiders</h1>
          <div>
            {user ? (
              <>
      ...
      {/* Page Title Area */}
      <div className="p-4 mb-4 rounded-3 dashboard-header-background">
