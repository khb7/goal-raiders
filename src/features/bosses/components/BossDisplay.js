...
const BossDisplay = () => {
  const { currentBoss, takingDamage, setEditingBossId, setEditingBossName, setEditingBossDifficulty, setEditingBossDueDate, setEditingParentBoss, setShowEditBossModal } = useBoss();
